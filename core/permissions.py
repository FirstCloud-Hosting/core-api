...
class PermissionsListsAPI(Resource):
    def __init__(self):
        ...
        self.reqparse.add_argument('permissions', type=str, help='List of permissions')
    ...
    def get(self, group_id):
        ...
        if group.organization_id == user.organization_id:
            ...
            query = database.Permissions.select().where(database.Permissions.group_id == group_id)
    ...
    def put(self, group_id):
        ...
        for permission in permissions:
            ...
            if 'creation' in permissions[permission] and 'edition' in permissions[permission] and 'deletion' in permissions[permission]:
        ...
        return {'status' : 200, 'message' : 'Permissions successfully added/edited'}

api.add_resource(PermissionsListsAPI, '/1.0/groups/<string:group_id>/permissions')